gen_plot <- function(data, name) {
	...
	#print(y_range)
	plot(NULL, NULL, xlim=x_range, ylim=y_range, xlab="number of MPI Send & Recv", ylab="time per MPI Send or Recv (s)", main = "Calibration of MPI rectangular array", pch=1)
