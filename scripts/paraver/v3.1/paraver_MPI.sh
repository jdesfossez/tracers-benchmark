...
change_cpus_governor_path=../../change_cpus_governor/v1.0

./$change_cpus_governor_path/change_cpus_governor.sh performance
#warmup
...
./$change_cpus_governor_path/change_cpus_governor.sh powersave
rm MPI_2Dexchange
