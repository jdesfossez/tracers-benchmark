...
data_lttng <- read.csv("git/compare_tracers/objective10.1/results/getuid_pthread_lttng.csv")
print(data_lttng)
...
data_lttng_snapshot <- read.csv("git/compare_tracers/objective10.1/results/getuid_pthread_lttng_snapshot.csv")
...
data_system_tap <- read.csv("git/compare_tracers/objective10.1/results/getuid_pthread_system_tap.csv")
...
data_perf <- read.csv("git/compare_tracers/objective10.1/results/getuid_pthread_perf.csv")
print(data_perf)
plot(data_perf$no_thread,data_perf$mean, xlab="Number of threads", ylab="Mean time per getuid call", main="Perf")

data_ftrace <- read.csv("git/compare_tracers/objective10.1/results/getuid_pthread_ftrace.csv")
print(data_ftrace)
